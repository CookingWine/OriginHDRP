...
namespace Origin
{
    ...
    internal sealed class Fsm<T>:FsmBase, IReference, IFsm<T> where T : class
    {
        ...
        public static Fsm<T> Create(string name , T owner , params FsmState<T>[] states)
        {
            ...
            fsm.Name = name;
            fsm.m_Owner = owner ?? throw new GameFrameworkException("FSM owner is invalid.");
        ...
        public bool HasData(string name)
        {
            ...
            return m_DataMap.ContainsKey(name);
        }
        ...
        public void SetData(string name , object data)
        {
            ...
            m_DataMap ??= new Dictionary<string , object>(StringComparer.Ordinal);
