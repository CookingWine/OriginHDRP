...
namespace Origin
{
    ...
    public abstract class GameFrameworkSerializer<T>
    {
        ...
        {
            m_SerializeCallbacks[version] = callback ?? throw new GameFrameworkException("Serialize callback is invalid.");
        ...
        {
            m_DeserializeCallbacks[version] = callback ?? throw new GameFrameworkException("Deserialize callback is invalid.");
        }
        ...
        {
            m_TryGetValueCallbacks[version] = callback ?? throw new GameFrameworkException("Try get value callback is invalid.");
        }
