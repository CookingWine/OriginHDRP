...
namespace Origin
{
    public static partial class Utility
    {
        ...
        {
            private static readonly System.Reflection.Assembly[] s_Aemblies = null;
            private static readonly Dictionary<string, Type> s_CachedTypes = new Dictionary<string, Type>(StringComparer.Ordinal);

            static Assembly()
            {
                s_Aemblies = AppDomain.CurrentDomain.GetAssemblies();
            }
            ...
            public static Type[] GetTypes()
            {
                ...
                foreach (System.Reflection.Assembly assembly in s_Aemblies)
                {
